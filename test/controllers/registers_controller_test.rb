...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { address: @register.address, deposit: @register.deposit, description: @register.description, monthlyfee: @register.monthlyfee, picture: @register.picture, title: @register.title, type: @register.type }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { address: @register.address, deposit: @register.deposit, description: @register.description, monthlyfee: @register.monthlyfee, picture: @register.picture, title: @register.title, type: @register.type }
    assert_redirected_to register_path(assigns(:register))
  end
